...
public static class BuildMura {
    ...
    public static void Build() {
        ...
        fix.spots = new[] {
            // ★S1-1（D-107）：置き場所は MuraCamCheck.Fit の 逆算（担当範囲⊆画角∧遮蔽なし）。
            //   手で 直すときは 直したあと 必ず -Only MuraCamCheck.Check を 回す
            S("いえ", 42f, -34f, 28f, 20f,   33.8f, 15.4f, -5.3f,   42f, 0.8f, -34f, 44f),
            S("ばすてい", 14f, -52f, 30f, 16f,   27.9f, 15.9f, -24.2f,   14f, 0.8f, -52f, 42f),
            S("みちみなみ", 27f, -27f, 16f, 26f,   22.2f, 14.4f, 0.5f,   27f, 0.8f, -27f, 42f),
            S("たんぼ", 10f, -18f, 26f, 20f,   10.0f, 15.4f, -48.0f,   10f, 0.8f, -18f, 42f),
            S("とびいし", 20f, 1f, 24f, 12f,   20.0f, 12.8f, -23.5f,   20f, 0.8f, 1f, 42f),
            S("はし", -30f, 8f, 18f, 18f,   -17.3f, 11.6f, -10.1f,   -30f, 0.8f, 8f, 44f),
            S("かわ きた", 6f, 16f, 44f, 12f,   6.0f, 20.1f, 55.6f,   6f, 0.8f, 16f, 44f),
            S("だがしや", -40f, -2f, 16f, 14f,   -20.6f, 10.3f, -3.2f,   -40f, 0.8f, -2f, 42f),
            S("いしだん", -45f, 16f, 14f, 12f,   -45.0f, 9.5f, -1.8f,   -45f, 0.8f, 16f, 40f),
            S("ほこら", -48f, 38f, 40f, 30f,   -4.4f, 23.1f, 24.3f,   -48f, 0.8f, 38f, 42f),
            S("たかだい", -62f, -32f, 30f, 26f,   -91.9f, 15.4f, -32.0f,   -62f, 0.8f, -32f, 50f),
            S("さか", -40f, -20f, 12f, 26f,   -41.5f, 12.9f, 4.8f,   -40f, 0.8f, -20f, 44f),
            S("いけ", 55f, 26f, 22f, 16f,   32.8f, 12.9f, 14.9f,   55f, 0.8f, 26f, 42f),
            S("たけやぶ", 62f, -26f, 18f, 16f,   48.5f, 11.5f, -8.6f,   62f, 0.8f, -26f, 42f),
            S("やまみち", -20f, 44f, 16f, 12f,   -20.0f, 9.3f, 26.6f,   -20f, 0.8f, 44f, 44f),
            S("ひみつきち", -10f, 52f, 18f, 10f,   -10.0f, 10.0f, 33.2f,   -10f, 0.8f, 52f, 42f),
            S("さわ", 25f, 50f, 20f, 10f,   25.0f, 10.8f, 29.6f,   25f, 0.8f, 50f, 42f),
