...
public static class BuildZashiki {
    ...
    public static void Build() {
        ...
        // ★**1日の 長さを 42分 → 26分に する。**（2026-08-17）
        //   遊ぶ 人：「1日 42分 × 31日 ＝ 約22時間。これは 長すぎませんか。
        //     ぼくなつは 10〜15時間 です」
        //   22時間 遊んで 確かめる ことは できない ので、**1日ぶんの 中みを 測った**
        //  （-jikan）。用意した 遊び 17個を **ぜんぶ やっても 78びょう**。
        //   人が 読む 間を 3倍 見ても 4分。のこりは 歩く ことと 虫を 追う ことで、
        //   それは 良い ものだが、**42分ぶんは 無い**。
        //   26分 × 31日 ＝ 約13時間で ぼくなつと 同じ 帯に 入る
        todc.realMinutesPerDay = 26f;
        todc.Apply();
        ...
        // できごとの 台詞（おばあちゃん）
        if (people.Count > 0) {
            var g = people[people.Count - 1];
            g.kotoYokoku  = new[] { "あさっては 祭りだよ。ゆかた、出して おいたからね" };
            g.kotoMatsuri = new[] { "よく 来たね。はい、これ 小づかい。屋台で 何か おあがり" };
            ...
            g.linesJo = new[] {
                ...
                "夕がたに なったら 蚊が 出る からね",
                "あんたの おかあさんも 小さい ころ 虫を とって いたよ",
                "ここらは 水が うまい。それだけが じまん だよ",
                "縁側の いたが きしむ だろ。あれは じいさんが 直しそこねた とこ",
            };
            g.linesChu = new[] {
                "もう 半分 すぎたねえ。はやい もんだ",
                "そろそろ 日が みじかく なって くるよ",
                "あんた、よく 日に やけたねえ。ちゃんと 帰って きて えらい",
                "ばあちゃんが 子どもの ころは、川で 泳いでも 怒られなかったよ",
                "うちの 井戸はね、ひでりの 年でも かれた ことが ないんだよ",
                "夜に なると 山から 風が おりて くる。あれで すずしく なる",
            };
            g.linesGe = new[] {
                "もう すぐ 帰るんだねえ。……なんだか さみしいよ",
                "あんたの ぶんの ふとん、まだ しばらく 出して おこうかね",
                "夏の おわりは、いつも きゅうに 来る んだよ",
                "むしの 声が 変わったろ。もう 秋の 虫だよ",
                "来年も おいで。ばあちゃん、まだ 元気で いるからね",
                "写真、とって おけば よかったねえ",
            };
        ...
        if (people.Count > 0) {
            var g = people[people.Count - 1];
            g.kotoYokoku  = new[] { "あさって 祭りだ。提灯 つるすの 手つだって くれるか？" };
            ...
            g.linesJo = new[] {
                ...
                "山の 上まで 行くなら、日が くれる 前に 帰れよ",
                "この へんは カブトムシが 多い。雑木林を さがして みろ",
                "朝はやいのは えらいぞ。虫も 人も、早いのが 勝ちだ",
                "谷の おくの 町まで 行くなら、水筒 持って いけよ",
            };
            g.linesChu = new[] {
                "そろそろ 稲の 穂が 出る ころだ。よく 見て みろ",
                "夕立が 来そうな 日は、雲の 底が 平らに なる",
                "川の 水が つめたく なって きた。もう 泳ぐ 季節じゃ ないな",
                "おれも 子どもの ころ、ここで さんざん あそんだ",
                "むしずもうは 大きさ じゃない。あれは 気合いだ",
            };
            g.linesGe = new[] {
                "朝ばんが すずしく なった。もう 秋だな",
                "とんぼが 増えたろ。あれが 出ると 夏は おしまいだ",
                "宿題、まだ なんだろ。顔に 書いて あるぞ",
                "来年も 来るんだろ？ 畑、そのままに して おくからな",
                "帰る 前に いっぺん、山の てっぺんまで 登って おけ",
            };
        ...
        if (people.Count > 0) {
            var g = people[people.Count - 1];
            g.kotoYokoku  = new[] { "祭りの じゅんびで みんな いそがしいよ" };
            g.kotoMatsuri = new[] { "金魚すくい、やって おいで。紙、すぐ やぶれる けどね" };
            ...
            g.linesJo = new[] {
                ...
                "せんたくもの、そこに ほして あるから さわらないでね",
                "祠の ほうへ 行くなら お参り して おいで",
                "けさ、にわとりが たまごを 3つ 産んだよ",
                "泥だらけで 帰って おいで。それが 夏だよ",
            };
            g.linesChu = new[] {
                "つけもの、そろそろ 食べごろ だよ",
                "きょうは 風が ある から、よく かわく ねえ",
                "夕がたの 風ろ、たきつけて おいたからね",
                "そういえば、川で 大きい さかなを 見た 人が いるらしいよ",
            };
            g.linesGe = new[] {
                "夜、まどを 開けっぱなしで 寝るんじゃ ないよ。冷えるからね",
                "おみやげに つけもの、持って いくかい？",
                "夏の おわりは かたづけが 多くて ねえ",
                "また 来年、手つだいに おいで。……うそだよ、あそんで いなさい",
            };
            g.mushi = new[] {
                "きゃっ、{0}！ ……こっちに 向けないでよ",
                "{0}ね。……虫は ちょっと にがてなのよ",
        ...
        if (people.Count > 0) {
            ...
            o.linesChu = new[] {
                "きょうは しずかだねえ。祭りが 終わると こんな もんだよ",
                "うちの 子も むかしは 毎日 来たよ。いまは 町に 出てる",
                "アイス、そろそろ 仕入れが へるからね。買うなら いま だよ",
            };
            o.linesGe = new[] {
                "あんた、もう 帰るんだろ。……さみしく なるねえ",
                "夏の おわりは 店も ひまでねえ。9月は 3日に 1回しか 開けないよ",
                "来年 来たら、また のぞきに おいで",
            };
        }

        foreach (var pn in people) if (pn != null) pn.player = player.transform;
        var people2 = new System.Collections.Generic.List<Npc>(people);
        people.Clear();
        ...
        // --- 大妖精。**川べりに いる。**気弱で おっとりして いて、ちょっと 抜けて いる
        {
            ...
            dnpc.linesJo = new[] {
                ...
                "むしずもう、こわいから みてる だけで いいです……",
                "この 川、ずっと さきは 海に つづいて いるんですって",
                "石を ひっくりかえすと、小さい のが いっぱい います",
            };
            dnpc.linesChu = new[] {
                "水が すこし つめたく なりました。……気の せい でしょうか",
                "きのう、ほたるを 見ました。もう 少なく なりましたけど",
                "まりささん、いつも 元気ですね。……うらやましいです",
                "とうろう、きれいでしたね。わたし、ずっと 見て いました",
            };
            dnpc.linesGe = new[] {
                "とんぼが ふえましたね。……夏、おわっちゃいますね",
                "夕がたが、はやく なりました",
                "わたし、ここに ずっと いますから。いつでも 来て ください",
                "……あの、こんど 来る とき、また こえを かけて くださいね",
            };
            people2.Add(dnpc);
        }

        // ================= 行事（ぎょうじ）の 飾り =================
        // ★**祭りを 作ってから「祭りだ」と 言う。**（2026-08-17・遊ぶ 人の 指摘
        //   「8月10日の 朝『きょうは 祭りだ！』と 言う。夜まで 待って 祠へ 行く。
        //     何も ありません。これは カレンダーが 無かった 昨日より 悪い」）
        //   飾りは **ここで ぜんぶ 建てて おいて、Gyoji が 出し入れ するだけ**。
        //   走って いる あいだに 建てると 重いし 地めんを 測りなおす ことに なる
        var gyojiGO = new GameObject("Gyoji");
        gyojiGO.transform.SetParent(root, false);
        var gyoji = gyojiGO.AddComponent<Gyoji>();
        {
            // 祠の 場所（BuildVillage と そろえる）
            float hx = 26.0f, hz = -11.0f;
            ...
            // ---- とうろう流し（川に ちいさな あかりが ならぶ）
            var to = new GameObject("Toro");
            to.transform.SetParent(root, false);
            for (int i = 0; i < 14; i++) {
                float x = -18f + i * 3.0f, z = 30.0f + Mathf.Sin(i * 1.3f) * 0.8f;
                float y = -0.9f;
                Box("T_Toro" + i, to.transform, new Vector3(x, y, z), new Vector3(0.30f, 0.24f, 0.30f), mPaper);
                var tl = new GameObject("Hi");
                tl.transform.SetParent(to.transform, false);
                tl.transform.position = new Vector3(x, y + 0.2f, z);
                var tt = tl.AddComponent<Light>();
                tt.type = LightType.Point; tt.color = new Color(1f, 0.66f, 0.30f);
                tt.intensity = 1.8f; tt.range = 4f; tt.shadows = LightShadows.None;
            }
            to.SetActive(false);
            gyoji.toro = to;

            // ---- 虹（夕立の あと。高台から 見える ように 大きく）
            var nj = new GameObject("Niji");
            nj.transform.SetParent(root, false);
            var cols = new[] {
                new Color(0.86f, 0.30f, 0.28f), new Color(0.92f, 0.58f, 0.24f),
                new Color(0.92f, 0.86f, 0.34f), new Color(0.40f, 0.76f, 0.40f),
                new Color(0.34f, 0.58f, 0.88f), new Color(0.50f, 0.38f, 0.78f),
            };
            for (int i = 0; i < cols.Length; i++) {
                var band = GameObject.CreatePrimitive(PrimitiveType.Quad);
                band.name = "Niji" + i;
                band.transform.SetParent(nj.transform, false);
                Object.DestroyImmediate(band.GetComponent<Collider>());
                band.transform.position = new Vector3(-6f, 34f - i * 1.6f, -62f);
                band.transform.localScale = new Vector3(96f, 3.0f, 1f);
                var bm = new Material(Shader.Find("Universal Render Pipeline/Unlit"));
                var cc = cols[i]; cc.a = 0.30f; bm.color = cc;
                bm.SetFloat("_Surface", 1f); bm.renderQueue = 3100;
                bm.SetInt("_SrcBlend", (int)UnityEngine.Rendering.BlendMode.SrcAlpha);
                bm.SetInt("_DstBlend", (int)UnityEngine.Rendering.BlendMode.One);
                bm.SetFloat("_ZWrite", 0f);
                AssetDatabase.CreateAsset(bm, MatDir + "Niji" + i + ".mat");
                band.GetComponent<Renderer>().sharedMaterial = bm;
                band.GetComponent<Renderer>().shadowCastingMode =
                    UnityEngine.Rendering.ShadowCastingMode.Off;
            }
            nj.SetActive(false);
            gyoji.niji = nj;

            gyoji.people = people2.ToArray();
        }
        dayHost.gyoji = gyoji;
        dayHost.weather = wx;
