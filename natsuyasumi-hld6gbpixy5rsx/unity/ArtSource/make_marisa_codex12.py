...
#   ★さらに 本人「ちょっとカクカクすぎるね」。4枚だと **7fps** にしか ならない。
#     気に入って いる 奥向きは **8枚・14fps・1コマの 変化 3024**。
#     ひざを 上げない コマは 12枚中 **6枚**（1,2,6,7,8,12）が 上限 なので それを 全部 つかう。
#     → 10.5fps・1コマの 変化 3508。4枚（7fps・5068）より 奥向きに ずっと 近い。
#   ★6と12（降り）は **足は 低い まま 歩はばだけ 大きい**。「足が上がりすぎ」には あたらない
TSUKAU = [1, 2, 6, 7, 8, 12]
